(function (root) {
  ...
  var locationOptions = [
    ...
    option("on-table", "на столе", "⬆️🍽️"),
    option("under-table", "под столом", "⬇️🍽️"),
  ...
  var dictionary = [
    ...
    entry("u6-stol", "стол", "🍽️", "word", "stol.mp3"),
  ...
  var lesson17Slides = [
    ...
    slide("u6-l17-3", "под", ["под", "Мяч под столом."], loc("under", "⚽", "🍽️"), [line("под. Мяч под столом.", "u6_l17_pod_myach_pod_stolom.mp3")], null, true),
    slide("u6-l17-4", "Где мяч?", ["Где мяч?"], loc("under", "⚽", "🍽️"), [line("Где мяч?", "gde_myach.mp3")], [question("u6-l17-q1", "Где мяч?", locationOptions.slice(0, 3), "under-table", "⚽")], true),
    ...
    slide("u6-l17-6", "Книга на столе.", ["Книга на столе."], loc("on", "📘", "🍽️"), [line("Книга на столе.", "kniga_na_stole.mp3")], null, true),
    slide("u6-l17-7", "Кот под столом.", ["Кот под столом."], loc("under", "🐱", "🍽️"), [line("Кот под столом.", "kot_pod_stolom.mp3")], null, true),
    slide("u6-l17-8", "Кот в доме.", ["Кот в доме."], loc("in", "🐱", "🏠"), [line("Кот в доме.", "kot_v_dome.mp3")], null, true),
    slide("u6-l17-9", "Мяч на стуле.", ["Мяч на стуле."], loc("on", "⚽", "🪑"), [line("Мяч на стуле.", "myach_na_stule.mp3")], [question("u6-l17-q3", "Где мяч?", [option("on-chair", "на стуле", "⬆️🪑"), option("under-table", "под столом", "⬇️🍽️"), option("in-box", "в коробке", "📦")], "on-chair", "⚽")], true),
    slide("u6-l17-10", "Да или нет", ["Книга в коробке."], loc("on", "📘", "🍽️"), [line("Книга в коробке.", "kniga_v_korobke.mp3")], [question("u6-l17-q4", "Книга в коробке?", yesNoOptions, "net", "📘")], true),
    slide("u6-l17-11", "Читай", ["Кот под столом.", "Книга на столе.", "Мяч в коробке."], focus(["🐱⬇️🍽️", "📘⬆️🍽️", "⚽📦"]), [line("Кот под столом. Книга на столе. Мяч в коробке.", "u6_l17_text_1.mp3")], [question("u6-l17-q5", "Где кот?", locationOptions.slice(0, 3), "under-table", "🐱")], true),
  ...
  var lesson18Slides = [
    ...
    slide("u6-l18-3", "Где кот?", ["Где кот?"], loc("near", "🐱", "🏠"), [line("Где кот?", "gde_kot.mp3")], [question("u6-l18-q1", "Где кот?", [option("near-house", "рядом с домом", "↔️🏠"), option("in-house", "в доме", "🏠"), option("under-table", "под столом", "⬇️🍽️")], "near-house", "🐱")], true),
  ...
  var catPhraseOptions = [
    ...
    gameOption("cat-under-table", "Кот под столом.", "⬇️🍽️"),
  ...
  var catQuizGame = {
    ...
    rounds: [
      quizRound("u6-cat-1", "Где кот?", scene("on", "🐱", "🍽️"), "cat-on-table", catPhraseOptions.slice(0, 3), "u6_cat_on_table.mp3", "Да! Кот на столе. 🐱"),
      quizRound("u6-cat-2", "Где кот?", scene("under", "🐱", "🍽️"), "cat-under-table", catPhraseOptions.slice(0, 3), "u6_cat_under_table.mp3", "Да! Кот под столом. 🐱"),
      ...
      quizRound("u6-cat-9", "Где кот?", scene("near", "🐱", "🍽️"), "cat-near-table", [gameOption("cat-near-table", "Кот рядом со столом.", "↔️🍽️"), catPhraseOptions[0], catPhraseOptions[1]], "u6_cat_near_table.mp3", "Да! Кот рядом. 🐱"),
  ...
  var roomGame = {
    ...
    scenes: [
      roomScene("u6-room-easy", "Комната 1", [
        ...
        roomQuestion("choice", "u6-room-1-q1", "Где мяч?", "under_table", [gameOption("on_table", "на столе", "⬆️🍽️"), gameOption("under_table", "под столом", "⬇️🍽️"), gameOption("in_box", "в коробке", "📦")], "u6_room_gde_myach.mp3"),
      ...
      roomScene("u6-room-cat-dog", "Комната 2", [
        ...
        roomQuestion("choice", "u6-room-2-q1", "Где кот?", "under_table", [gameOption("under_table", "под столом", "⬇️🍽️"), gameOption("in_box", "в коробке", "📦"), gameOption("near_house", "рядом с домом", "↔️🏠")], "u6_room_gde_kot.mp3"),
      ...
      roomScene("u6-room-house", "Комната 3", [
        ...
        roomQuestion("choice", "u6-room-3-q1", "Где мама?", "in_house", [gameOption("in_house", "в доме", "🏠"), gameOption("near_house", "рядом с домом", "↔️🏠"), gameOption("under_table", "под столом", "⬇️🍽️")], "u6_room_gde_mama.mp3"),
